...
import { loadAns, loadButtons, loadClear, loadBackspace } from '../redux/calculatorRedux/calculator.action';
...
const CalculatorApp = () => {
  ...
  return {
    ...state[CALCULATOR_KEY],
    ans: '', // Initialize the ans property to an empty string
  };
});
